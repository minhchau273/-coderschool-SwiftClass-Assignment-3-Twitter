...
class UpdateViewController: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if replyTweet != nil {
            ...
            if let replyScreeName = replyTweet?.user?.screenName {
                ...
                limit = 140 - count(tweetText.text.utf8)
    ...
    func hideReply() {
        ...
        replyIcon.setTranslatesAutoresizingMaskIntoConstraints(false)
        ...
        replyLabel.setTranslatesAutoresizingMaskIntoConstraints(false)
